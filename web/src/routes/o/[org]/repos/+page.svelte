<script lang="ts">
   ...
   * the server cannot see what an agent does with the resource and cannot stop
   * it — so its whole value is being *visible*: "why is my agent waiting?" is
   * answered by a name and a resource, not by a lock.
   *
