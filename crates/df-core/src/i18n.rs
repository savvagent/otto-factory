...
//! |---|---|
//! | `df_web::i18n` | `pub use df_core::i18n::Locale` — `df-core` cannot depend on `df-web`, so the enum lives here and the HTTP crate re-exports it |
...
impl FromStr for Locale {
    ...
    /// `df_web::i18n::negotiate` applies to `Accept-Language`.
