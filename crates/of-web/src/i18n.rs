...
///
/// Product nouns are not translated: `otto-factory`, JIRA and GitHub are names,
...
pub fn msg(locale: Locale, key: Key) -> &'static str {
    ...
    match (key, locale) {
        ...
        (ConsentHeading, En) => "Authorize access to otto-factory",
        (ConsentHeading, Es) => "Autorizar acceso a otto-factory",
        (ConsentHeading, De) => "Zugriff auf otto-factory autorisieren",
        (ConsentHeading, Fr) => "Autoriser l'accès à otto-factory",
        (ConsentHeading, It) => "Autorizza l'accesso a otto-factory",
        (ConsentHeading, Hi) => "otto-factory तक पहुँच अधिकृत करें",
