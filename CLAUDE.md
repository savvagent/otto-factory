...
(`ALTER TABLE ... ADD COLUMN`, a new `DEFAULT`, an index) is unaffected — none of this constrains
a table's own schema, only what its rows may be read, written, or matched against.
